...
# Date: 1/7/2026
##############################################################################
"""This contains all the dialogue and options for act eight."""
##############################################################################
...
act8_aftermath_intro3 = '''Your stomach drops.
...
act8_aftermath_intro4 = '''“You let me fight a dragon,” you hiss.
...
act8_final_exam_intro2 = '''The Beings of Higher Power hum with anticipation.
On the seventh day—
...
act8_final_exam_intro3 = '''Your chest tightens.
...
act8_final_exam_hall = '''The hall is vast.
Marble floors.
Floating sigils.
...
act8_final_exam_pass2 = '''Applause erupts.
...
act8_final_exam_pass3 = '''The system pauses.
...
act8_endings = '''FINAL PLAYER CHOICE
...
act8_end_crown_prince = '''CROWN PRINCE ENDING
“QUEEN OF THE REALM”
...
act8_end_tower_master = '''MAGIC TOWER MASTER/ ASSASSIN ENDING
“SHADOW AND FLAME”
...
# REAL WORLD ENDING
act8_end_return_real_world = '''RETURN ENDING
“AWAKE”
...
act8_post_credits2 = '''BEING #1(Aditi):
“Well?”
...
act8_post_credits3 = '''A new screen flickers to life.
The Beings smile.
...
def get_highest_love_interest(player):
    """Returns the character with the most love interest.
    Parameters:
        player (Player): the current player object

    Returns:
        The character with the most love points
    """
